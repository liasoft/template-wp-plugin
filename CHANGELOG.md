...
### Added
- Readiness check implementation for improved plugin status monitoring

### Changed
- Updated DevContainer environment configuration
- Migrated to GPL-3.0-or-later license
- Updated PHP requirement to 8.3

### Updated
- Bumped actions/checkout from 5 to 6 in CI/CD pipeline
